...
/**
 * 自有线上渠道国漫功能开通/关闭结果反馈接口
 * @author mengchao
 *
 */
@Component("TsnV1T3000318Inter")
public class TsnV1T3000318InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("TsnV1T3000318InterImpl init");
		reqParamMap.put("xmlhead", "^.*<ActivityCode>T3000318</ActivityCode>.*</InterBOSS>$");
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "T3000318" + "##" + interId;
