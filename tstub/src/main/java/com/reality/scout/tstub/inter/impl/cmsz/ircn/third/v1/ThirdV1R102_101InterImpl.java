 ...
 *
 */
@Component("ThirdV1R102_101Inter")
public class ThirdV1R102_101InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("ThirdV1R102_101InterImpl init");
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "R102_101" + "##" + interId;
