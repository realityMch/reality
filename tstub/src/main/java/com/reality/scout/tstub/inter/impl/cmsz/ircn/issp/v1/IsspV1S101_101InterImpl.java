 ...
 *
 */
@Component("IsspV1S101_101Inter")
public class IsspV1S101_101InterImpl implements Inter {
	...
	public void init() {
		...
		reqParamMap.put("xmlhead", "^.*<ActivityCode>S101_101</ActivityCode>.*</GRoaming>$");
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "S101_101" + "##" + interId;
