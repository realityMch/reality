...
import com.reality.scout.tstub.inter.impl.cmsz.ircn.third.v1.ThirdV1R102_101InterImpl;
@Component("ThirdV2R102_101Inter")
public class ThirdV2R102_101InterImpl implements Inter {
	...
	@Resource
	private ThirdV1R102_101InterImpl thirdV1R102_101Inter;
	@Override
	@PostConstruct
	public void init() {
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		String rsp = thirdV1R102_101Inter.accept(request, response);
		return null;
	}
