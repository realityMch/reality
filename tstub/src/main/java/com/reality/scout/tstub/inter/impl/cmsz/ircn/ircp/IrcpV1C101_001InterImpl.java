...
@Component("IrcpV1C101_001Inter")
public class IrcpV1C101_001InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("IrcpV1C101_001InterImpl init");
		reqParamMap.put("xmlhead", "^.*<ActivityCode>C101_001</ActivityCode>.*</GRoaming>$");
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "C101_001" + "##" + interId;
