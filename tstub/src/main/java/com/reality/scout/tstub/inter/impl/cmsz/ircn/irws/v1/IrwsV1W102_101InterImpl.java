 ...
 *
 */
@Component("IrwsV1W102_101Inter")
public class IrwsV1W102_101InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("IrwsV1W102_101InterImpl init");
		reqParamMap.put("xmlhead", "^.*<ActivityCode>W102_101</ActivityCode>.*<Msisdn>.*</Msisdn>.*</GRoaming>$");
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "W102_101" + "##" + interId;
