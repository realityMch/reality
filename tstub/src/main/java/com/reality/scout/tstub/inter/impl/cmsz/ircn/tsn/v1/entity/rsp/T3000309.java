...
@Entity(name = "tstub_tsn_v1_rsp_T3000309")
public class T3000309 {
	...
	public String getUserinfoQryRsp() {
		return userinfoQryRsp;
	}

	public void setUserinfoQryRsp(String userinfoQryRsp) {
		this.userinfoQryRsp = userinfoQryRsp;
	}
