 ...
 *
 */
@Component("TsnV1T3000314Inter")
public class TsnV1T3000314InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("TsnV1T3000314InterImpl init");
		reqParamMap.put("xmlhead", "^.*<ActivityCode>T3000314</ActivityCode>.*</InterBOSS>$");
		reqParamMap.put("xmlbody", "^.*<SmsRemindReq>.*<MSISDN>.*</MSISDN>.*$");
	}
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "T3000314" + "##" + interId;
