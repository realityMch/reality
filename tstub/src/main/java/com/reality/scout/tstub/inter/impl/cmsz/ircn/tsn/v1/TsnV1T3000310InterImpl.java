 ...
 *
 */
@Component("TsnV1T3000310Inter")
public class TsnV1T3000310InterImpl implements Inter {
	...
	@PostConstruct
	public void init() {
		System.out.println("TsnV1T3000310InterImpl init");
		reqParamMap.put("xmlhead", "^.*<ActivityCode>T3000310</ActivityCode>.*</InterBOSS>$");
		reqParamMap.put("xmlbody", "^.*<syncOrderRelationReq>.*<MSISDN>.*</MSISDN>.*$");
	}
	...
	public String accept(HttpServletRequest request, HttpServletResponse response) {
		...
		String commonId = "T3000310" + "##" + interId;
