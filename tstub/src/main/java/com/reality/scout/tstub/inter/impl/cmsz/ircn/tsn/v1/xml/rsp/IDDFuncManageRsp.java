 ...
 *
 */
@XStreamAlias(value = "IDDFuncManageRsp")
public class IDDFuncManageRsp {
	 ...
	 * 业务应答详细信息
	 */
	private IDDInfo IDDInfo;
	
	public IDDFuncManageRsp() {
		IDDInfo = new IDDInfo();
	}
	...
	public IDDInfo getIDDInfo() {
		return IDDInfo;
	}
	public void setIDDInfo(IDDInfo iDDInfo) {
		IDDInfo = iDDInfo;
	}
	/**
	 * 业务应答详细信息
